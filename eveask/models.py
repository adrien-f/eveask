...
from flask.ext.security import RoleMixin, SQLAlchemyUserDatastore, UserMixin
from eveask.app import db
...
class User(db.Model, UserMixin):
    ...
    corporation_name = db.Column(db.String(51))
    alliance_id = db.Column(db.Integer())
    alliance_name = db.Column(db.String(51))
